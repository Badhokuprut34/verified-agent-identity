...
    inputs:
      agent_name:
        description: 'Badhokuprut34'
        required: true
        default: 'Badhokuprut34'
      agent_description:
        description: 'Badhokuprut34'
        required: true
        default: 'Badhokuprut34 AI Agent'
...
        run: |
          node scripts/manualLinkHumanToAgent.js --challenge '{"name": "Badhokuprut34", "description": "Badhokuprut34 AI Agent"}'
